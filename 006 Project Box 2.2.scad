...
use_usb = true;		// [true, false]  // This value changes the box dimensions slightly
									  // be sure to use the same value for all parts
...
parts_headspace = 10;       // [10:50]  for future use
